...
namespace PMS_AISystem
{
    ...
    public class SituationCUR {
        ...
        public SituationCUR(string id, float x, float z, float dist, float angleComp, IntVector3 doing, bool isHitB)
        {
            _id = id;
            _posX = x;
            _posZ = z;
        ...
        public void InitSitCUR(string id, float x, float z, float dist, float angleComp, IntVector3 doing, bool isHitB)
        {
            _id = id;
            _posX = x;
            _posZ = z;
    ...
    public class SituationAFT {
        ...
        public SituationAFT(string id, float x, float z, float dist, float angleComp, string beforeID, int beforeDB, int hitCounter, bool closer, bool isHitB)
        {
            _id = id;
            _posX = x;
            _posZ = z;
        ...
        public void InitSitAFT(string id, float x, float z, float dist, float angleComp, string beforeID, int beforeDB, int hitCounter, bool closer, bool isHitB)
        {
            _id = id;
            _posX = x;
            _posZ = z;
