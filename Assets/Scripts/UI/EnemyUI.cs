...
public class EnemyUI : MonoBehaviour {
    ...
    void Start () {
        ...
        enemyMaxHP = (float)sEnemyController.__ENE_Stat.__GET_Max_HP;
    }
    ...
    private void OnGUI()
    {
        ...
        iHealthBar.fillAmount = (float)sEnemyController.__ENE_Stat.__PUB__Health_Point / enemyMaxHP; // status image udpate
